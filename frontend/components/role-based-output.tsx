              ...
              <CardContent className="space-y-6">
                {isReal ? (
                  <div className="p-4 bg-emerald-950/20 border border-emerald-900/30 rounded-xl flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-white">Media Verified as Authentic</h4>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  <Button 
                    ...
                    className="flex-1 bg-primary hover:bg-primary/90 text-white gap-2 h-12"
                  >
                ...
                {isReal && (
                  <div className="p-4 bg-emerald-950/20 border border-emerald-900/30 rounded-xl flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-white">Media Verified as Authentic</h4>
                      <p className="text-xs text-slate-400 mt-1">
                        This media has been classified as real/authentic. No evidence packet registration is required for genuine content.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <CardContent className="space-y-6">
                ...
                {!submittedReport ? (
                  <>
                    ...
                    <Button size="lg" onClick={handleReportOrRegister} disabled={loading || isReal} className="bg-primary hover:bg-primary/90 text-white gap-2 min-w-[200px]">
